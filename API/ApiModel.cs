    ...
    public class ApiModel
    {
        ...
        public class GetMenu
        {
            ...
            public class Response
            {
                ...
                {
                    string _TraceCategory = "CFSSK.Model.ApiModel.Category";
                ...
                {
                    string _TraceCategory = "CFSSK.Model.ApiModel.Product.DynamicModifier.Modifier";
                    public int minSelection { get; set; }
                    public int maxSelection { get; set; }
                    public string groupId { get; set; }
        ...
        public class FnBOrders
        {
            ...
            public class Response
            {
                ...
                public string PaymentForPromo{ get; set; }
                ...
                public string ListPromoCodeStatus { get; set; }
